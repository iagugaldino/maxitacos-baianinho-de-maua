document.addEventListener("DOMContentLoaded", function() {
    ...
    function initCarousel() {
        ...
        let currentIndex = 0;
        let currentOffset = 0;
        const imagesPerView = 7; // Quantas thumbnails são visíveis por vez
        const images = [
            'images/produtoevo.png',
            'images/add01.png', 
            'images/add02.png',
            'images/add03.png',
            'images/add4.png',
        ...
        function moveContainer() {
            const thumbnailWidth = 100 / imagesPerView; // % por thumbnail baseado em imagesPerView
